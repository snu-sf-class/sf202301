...
Check (APlus (AMinus (AMult (ANum 3) (ANum 5)) (ANum 7)) (ANum 2)).

Check (BEq (APlus (AMinus (AMult (ANum 3) (ANum 5)) (ANum 7)) (ANum 2)) (ANum 7)).
...
Compute aeval (APlus (AMinus (AMult (ANum 3) (ANum 5)) (ANum 7)) (ANum 2)).
...
Compute beval (BEq (APlus (AMinus (AMult (ANum 3) (ANum 5)) (ANum 7)) (ANum 2)) (ANum 7)).
...
Compute optimize_0plus (AMult (ANum 3) (APlus (ANum 0) (ANum 7))).

Compute optimize_0plus (optimize_0plus (APlus (APlus (ANum 0) (ANum 0)) (ANum 0))).
...
Proof.
  intros.
  induction a; simpl; try destruct a1; (try destruct n); (try rewrite <-IHa1); (try rewrite <-IHa2); eauto.
...
Proof.
  ...
  - generalize dependent n.
    induction a; simpl; intros; subst; eauto using aevalR.
...
Compute aeval (t_empty 42) example_aexp.

...
Proof.
  split; intros.
  - dependent destruction H; eauto using ceval.
    (*
    revert H.
    remember (<{ while b do c end }>) as cmd.
    intros REL. revert b c Heqcmd.
    induction REL; intros;
      try (inversion Heqcmd; subst; eauto using ceval; fail).
   *)
  - dependent destruction H; dependent destruction H0; eauto using ceval.
(*    
